...
import { BulletPoints, SingleLine, TwoLines } from './Decpription'; 
import useIsMobile from '@/hook/isMobile';
import Background from './Background';
import MobileScroller from '@/Components/MobileScroller';
import DesktopScroller from '@/Components/DesktopScroller';
